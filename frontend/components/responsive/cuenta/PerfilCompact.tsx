...
import { PrediosHead } from "@/components/responsive/predios/PrediosShell";
import { In } from "@/components/responsive/kit";
...
import {
  ABtn, Acciones, AcctCard, AcctToast, AVATAR_BG, BROWN, FField,
...
export function PerfilHeadCompact() {
  return (
...
/**
 * El cuerpo de la pantalla. El fondo, la barra, el encabezado y el par de
 * pestañas los monta `CuentaRoute`, que es quien se queda fijo mientras esto
 * entra y sale.
 */
