...
export default function ModeloSection2Christian() {
  return (
    <div className="bg-cream overflow-clip relative rounded-tr-[150px] size-full" data-name="Seccion 2">
      {/* Left text column */}
      <div className="absolute flex flex-col gap-[15px] items-start left-[281px] pt-[7.58px] right-[1166.8px] top-[208px]">
        {/* Eyebrow */}
      ...
      {/* Right image cards */}
      <div className="absolute h-[706px] left-[843px] rounded-[50px] overflow-clip shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[97px] w-[485px]">
      ...
      <div className="absolute h-[393px] left-[1337px] rounded-[50px] overflow-clip shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[97px] w-[306px]">
      ...
      <div className="absolute h-[302px] left-[1337px] rounded-[50px] overflow-clip shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[501px] w-[306px]">
