...
export default function ModeloSection1Hero() {
  return (
    <div className="relative size-full" data-name="Seccion 1">
      ...
      <a href="/solicitud-acceso" className="ix-invert ix-pulse absolute bg-cream h-[104px] left-[758px] overflow-clip rounded-[98px] shadow-[0px_4px_6px_0px_rgba(0,0,0,0.25)] top-[682px] w-[404px] flex items-center justify-center">
